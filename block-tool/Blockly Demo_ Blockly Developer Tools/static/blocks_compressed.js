...
(function(root, factory) {
    ...
    Blockly.Blocks.lists_split = {
        init: function() {
            ...
            this.setOutput(!0,
                "Array");
            this.setTooltip(function() { var c = a.getFieldValue("MODE"); if ("SPLIT" == c) return Blockly.Msg.LISTS_SPLIT_TOOLTIP_SPLIT; if ("JOIN" == c) return Blockly.Msg.LISTS_SPLIT_TOOLTIP_JOIN; throw Error("Unknown mode: " + c); })
        },
    ...
    Blockly.Blocks.procedures_mutatorarg = {
        ...
        validator_: function(a) {
            ...
            for (var d = (b.workspace.targetWorkspace || b.workspace).getAllBlocks(!1), e = a.toLowerCase(), f = 0; f < d.length; f++)
                if (d[f].id != this.getSourceBlock().id) { var g = d[f].getFieldValue("NAME"); if (g && g.toLowerCase() == e) return null }
    ...
    Blockly.Blocks.text_prompt_ext = {
        init: function() {
            ...
            this.setStyle("text_blocks");
            var b = this;
            a = new Blockly.FieldDropdown(a, function(c) { b.updateType_(c) });
