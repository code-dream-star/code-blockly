...
WorkspaceFactoryGenerator.prototype.generateInjectString = function() {
  ...
  var finalStr = '/* TODO: 如有必要，更改工具箱XML ID。可以从工作区工厂导出工具箱XML。 */\n' +
      'var toolbox = document.getElementById("toolbox");\n\n';
  finalStr += 'var options = { \n' + attributes + '};';
  finalStr += '\n\n/* 注入您的工作空间 */ \nvar workspace = Blockly.' +
      'inject(/* TODO: 添加要为 Blockly 注入的div的ID */, options);';
  finalStr += '\n\n/* 将工作区积木从XML加载到工作区。如果没有要加载的积木，请删除下面的所有代码 */\n\n' +
      '/* TODO: 如有必要，更改工作空间积木XML ID。可以从工作区工厂导出工作区积木XML。 */\n' +
