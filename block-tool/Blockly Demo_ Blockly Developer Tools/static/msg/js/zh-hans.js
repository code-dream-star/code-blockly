...
Blockly.Msg["COLLAPSED_WARNINGS_WARNING"] = "已收起的信息积木内包含警告。";
...
Blockly.Msg["CONTROLS_FLOW_STATEMENTS_WARNING"] = "提示：这个积木只能在循环内使用。";
...
Blockly.Msg["CONTROLS_FOR_TOOLTIP"] = "用变量%1记录从开始数值到终止数值之间的数值，数值按指定间隔增加，并执行指定的积木。";
Blockly.Msg["CONTROLS_IF_ELSEIF_TOOLTIP"] = "在这个if语句积木中增加一个条件。";
Blockly.Msg["CONTROLS_IF_ELSE_TOOLTIP"] = "在这个if语句积木中添加一个最终的，包括所有其余情况的条件。";
...
Blockly.Msg["CONTROLS_IF_TOOLTIP_2"] = "如果值为真，则执行第一部分的语句。否则，则执行第二部分的语句。";
Blockly.Msg["CONTROLS_IF_TOOLTIP_3"] = "如果第一个值为真，则执行第一部分的的语句。否则，如果第二个值为真，则执行第二部分的的语句。";
Blockly.Msg["CONTROLS_IF_TOOLTIP_4"] = "如果第一个值为真，则执行第一部分的对语句。否则，如果第二个值为真，则执行语句的第二部分的。如果没有值为真，则执行最后一部分的语句。";
...
Blockly.Msg["DELETE_ALL_BLOCKS"] = "确认要删除 %1 个积木吗？";
...
Blockly.Msg["PROCEDURES_IFRETURN_WARNING"] = "提示：这个积木只能在函数内部使用。";
...
Blockly.Msg["TEXT_CREATE_JOIN_TOOLTIP"] = "添加、移除或重新排列各节来重新配置这个文本积木。";
