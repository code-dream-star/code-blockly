...
// xiaohong2022 change several places.
...
(function (root, factory) {
    ...
    var module$contents$Blockly$libraryBlocks$variablesDynamic_CUSTOM_CONTEXT_MENU_VARIABLE_GETTER_SETTER_MIXIN =
            {
                customContextMenu: function (a) {
                    if (!this.isInFlyout) {
                        ...
                        d.appendChild(
                            $.module$build$src$core$utils$xml.createTextNode(f)
                        );
                        c =
                            $.module$build$src$core$utils$xml.createElement(
                                "block"
    ...
    var module$contents$Blockly$libraryBlocks$variables_CUSTOM_CONTEXT_MENU_VARIABLE_GETTER_SETTER_MIXIN =
            {
                customContextMenu: function (a) {
                    if (!this.isInFlyout) {
                        ...
                        c.appendChild(
                            $.module$build$src$core$utils$xml.createTextNode(e)
                        );
                        e =
                            $.module$build$src$core$utils$xml.createElement(
                                "block"
    ...
    module$exports$Blockly$libraryBlocks$texts.blocks.text_print = {
        init: function () {
            this.jsonInit({
                ...
                style: "text_blocks",
                tooltip:
                    module$contents$Blockly$libraryBlocks$texts_Msg.TEXT_PRINT_TOOLTIP,
                helpUrl:
                    module$contents$Blockly$libraryBlocks$texts_Msg.TEXT_PRINT_HELPURL,
            });
        },
    };
    ...
    module$exports$Blockly$libraryBlocks$texts.blocks.text_count = {
        init: function () {
            this.jsonInit({
                ...
                style: "text_blocks",
                tooltip:
                    module$contents$Blockly$libraryBlocks$texts_Msg.TEXT_COUNT_TOOLTIP,
                helpUrl:
                    module$contents$Blockly$libraryBlocks$texts_Msg.TEXT_COUNT_HELPURL,
            });
        },
    };
    module$exports$Blockly$libraryBlocks$texts.blocks.text_replace = {
        init: function () {
            this.jsonInit({
                ...
                style: "text_blocks",
                tooltip:
                    module$contents$Blockly$libraryBlocks$texts_Msg.TEXT_REPLACE_TOOLTIP,
                helpUrl:
                    module$contents$Blockly$libraryBlocks$texts_Msg.TEXT_REPLACE_HELPURL,
            });
        },
    };
    module$exports$Blockly$libraryBlocks$texts.blocks.text_reverse = {
        init: function () {
            this.jsonInit({
                ...
                style: "text_blocks",
                tooltip:
                    module$contents$Blockly$libraryBlocks$texts_Msg.TEXT_REVERSE_TOOLTIP,
                helpUrl:
                    module$contents$Blockly$libraryBlocks$texts_Msg.TEXT_REVERSE_HELPURL,
            });
        },
    };
                ...
                this.setTooltip(function () {
                    ...
                    ("FROM_START" === b || "FROM_END" === b) &&
                        ...
                        (c +=
                            ...
                            b.replace(
                                "%1",
                                a.workspace.options.oneBasedIndex ? "#1" : "#0"
                            ));
                    return c;
                });
            };
    ...
    var module$contents$Blockly$libraryBlocks$procedures_PROCEDURE_DEF_COMMON =
        {
            ...
            domToMutation: function (a) {
                ...
                for (let c = 0, d; (d = a.childNodes[c]); c++)
                    if ("arg" === d.nodeName.toLowerCase()) {
                        ...
                        var b =
                            d.getAttribute("varid") || d.getAttribute("varId");
                        ...
                        null !== b
                            ...
                            : console.log(
                                  "Failed to create a variable with name " +
                                      e +
                                      ", ignoring."
                              );
                    }
            ...
            decompose: function (a) {
                const b =
                    $.module$build$src$core$utils$xml.createElement("block");
                ...
                for (let e = 0; e < this.arguments_.length; e++) {
                    ...
                    const g = $.module$build$src$core$utils$xml.createTextNode(
                        this.arguments_[e]
                    );
                    d.appendChild(g);
                    f.appendChild(d);
    ...
    module$exports$Blockly$libraryBlocks$procedures.blocks.procedures_defnoreturn =
        Object.assign(
            ...
            {
                init: function () {
                    var a = $.module$build$src$core$procedures.findLegalName(
                        "",
                        this
                    );
                    a =
                    ...
                    (this.workspace.options.comments ||
                        (this.workspace.options.parentWorkspace &&
                            this.workspace.options.parentWorkspace.options
                                .comments)) &&
            ...
            module$contents$Blockly$libraryBlocks$procedures_PROCEDURE_DEF_COMMON,
            {
                init: function () {
                    ...
                    this.appendValueInput("RETURN")
                        .setAlign($.Align$$module$build$src$core$input.RIGHT)
                        .appendField(
    ...
    module$exports$Blockly$libraryBlocks$procedures.blocks.procedures_mutatorarg =
        {
            ...
            validator_: function (a) {
                ...
                const c = $.Mutator$$module$build$src$core$mutator.findParentWs(
                    b.workspace
                );
            ...
            deleteIntermediateVars_: function (a) {
                const b = $.Mutator$$module$build$src$core$mutator.findParentWs(
    ...
    var module$contents$Blockly$libraryBlocks$procedures_PROCEDURE_CALL_COMMON =
        {
                ...
                if (a.join("\n") === this.arguments_.join("\n"))
                    ...
                    for (let f = 0; f < this.arguments_.length; f++) {
                        ...
                        e &&
                            ...
                            (this.quarkConnections_[this.quarkIds_[f]] = e),
                            d &&
                                e &&
            ...
            mutationToDom: function () {
                ...
                for (let b = 0; b < this.arguments_.length; b++) {
                    const c =
                        $.module$build$src$core$utils$xml.createElement("arg");
            ...
            onchange: function (a) {
                if (this.workspace && !this.workspace.isFlyout && a.recordUndo)
                    if (
                        ...
                        b = $.module$build$src$core$procedures.getDefinition(
                            b,
                            this.workspace
                        );
                        !b ||
                        ...
                        a.type ===
                            $.module$build$src$core$events$events
                                .BLOCK_DELETE && a.blockId != this.id
    ...
    module$exports$Blockly$libraryBlocks$procedures.blocks.procedures_ifreturn =
        {
            ...
            onchange: function (a) {
                if (
                    ...
                    this.isInFlyout ||
                        ((c = $.module$build$src$core$events$events.getGroup()),
    ...
    var module$contents$Blockly$libraryBlocks$loops_CONTROL_FLOW_IN_LOOP_CHECK_MIXIN =
        {
            ...
            onchange: function (a) {
                if (
                    this.workspace.isDragging &&
                    !this.workspace.isDragging() &&
                    a.type === $.module$build$src$core$events$events.BLOCK_MOVE
                ) {
    ...
    module$exports$Blockly$libraryBlocks$lists.blocks.lists_getIndex = {
        init: function () {
            ...
            this.setStyle("list_blocks");
            a = new module$contents$Blockly$libraryBlocks$lists_FieldDropdown(
                a,
                function (c) {
                    c = "REMOVE" === c;
        ...
        loadExtraState: function (a) {
            a.isStatement
                ...
                : "string" === typeof a &&
                  this.domToMutation($.module$build$src$core$xml.textToDom(a));
        },
