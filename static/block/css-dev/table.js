...
Blockly.Blocks['table_border_fold'] = {
    init: function() {
  ...
  Blockly.JavaScript['table_border_fold'] = function(block) {
  ...
  Blockly.JavaScript['table_color'] = function(block) {
