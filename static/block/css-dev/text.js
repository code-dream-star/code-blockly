...
Blockly.Blocks['css_Font_Series'] = {
    init: function() {
        this.appendDummyInput()
        .appendField("字体系列");
  ...
  Blockly.JavaScript['css_Font_Series'] = function(block) {
...
Blockly.Blocks['css_Add_Font'] = {
  ...
  Blockly.JavaScript['css_Add_Font'] = function(block) {
