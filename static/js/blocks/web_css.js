...
Blockly.JavaScript["web_css_Create"] = function (block) {
...
Blockly.JavaScript["web_css_Color"] = function (block) {
     var colour_color = block.getFieldValue("color");
     var code = `${colour_color}`;
     return [code, Blockly.JavaScript.ORDER_NONE];
};

Blockly.Blocks["web_css_Color_RGB"] = {
     init: function () {
          this.appendDummyInput()
               .appendField("R")
...
Blockly.JavaScript["web_css_Color_RGB"] = function (block) {
...
Blockly.Blocks["web_css_Color_16"] = {
     init: function () {
          this.appendDummyInput()
               .appendField("16进制")
...
Blockly.JavaScript["web_css_Color_16"] = function (block) {
     var color = block.getFieldValue("color");
     var code = `${color}`;
     return [code, Blockly.JavaScript.ORDER_NONE];
};

Blockly.Blocks["web_css_Unit"] = {
     init: function () {
          this.appendDummyInput()
...
Blockly.JavaScript["web_css_Unit"] = function (block) {
...
Blockly.JavaScript["web_css_height"] = function (block) {
...
Blockly.JavaScript["web_css_width"] = function (block) {
     var value_name = Blockly.JavaScript.valueToCode(
          block,
          "NAME",
          Blockly.JavaScript.ORDER_ATOMIC
