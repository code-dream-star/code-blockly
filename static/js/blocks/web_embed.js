...
Blockly.JavaScript["web_script"] = function (block) {
    var statements_code = Blockly.JavaScript.statementToCode(block, "CODE");
    var code = `<script>\n${statements_code}</script>\n`;
    return code;
};

Blockly.Blocks["web_style"] = {
    init: function () {
...
Blockly.JavaScript["web_style"] = function (block) {
    var statements_code = Blockly.JavaScript.statementToCode(block, "CODE");
...
Blockly.JavaScript["web_iframe"] = function (block) {
