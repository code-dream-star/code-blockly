 ...
 * 文档×
 */
Blockly.Blocks["web_create_a_form"] = {
    init: function () {
...
Blockly.JavaScript["web_create_a_form"] = function (block) {
...
Blockly.Blocks["web_form_submit_button"] = {
    init: function () {
...
Blockly.JavaScript["web_form_submit_button"] = function (block) {
...
Blockly.Blocks["web_form_bounding_box"] = {
    init: function () {
        this.appendDummyInput()
...
Blockly.JavaScript["web_form_bounding_box"] = function (block) {
...
Blockly.Blocks["web_form_text_box"] = {
    init: function () {
        this.appendDummyInput()
            .appendField("[表单功能] 创建")
            .appendField(
...
Blockly.JavaScript["web_form_text_box"] = function (block) {
...
Blockly.Blocks["web_form_select_box"] = {
    init: function () {
        this.appendDummyInput()
            .appendField("[表单功能] 创建")
            .appendField(
...
Blockly.JavaScript["web_form_select_box"] = function (block) {
    var dropdown_drop_down_menu = block.getFieldValue("drop-down menu");
...
Blockly.Blocks['web_form_select_down_menu'] = {
    init: function () {
        this.appendDummyInput()
            .appendField("[表单功能]")
            .appendField("创建下拉选择框");
...
Blockly.JavaScript['web_form_select_down_menu'] = function (block) {
...
Blockly.Blocks['web_form_select_down_menu_optgroup'] = {
    init: function () {
        this.appendDummyInput()
            .appendField("[下拉选择框功能]")
            .appendField("建造分组");
...
Blockly.JavaScript['web_form_select_down_menu_optgroup'] = function (block) {
...
Blockly.Blocks['web_form_select_down_menu_option'] = {
    init: function () {
        this.appendDummyInput()
            .appendField("[下拉选择框功能]")
            .appendField("建造选项");
...
Blockly.JavaScript['web_form_select_down_menu_option'] = function (block) {
